...
public class CThostFtdcReqFutureSignOutField extends StructObject {
	 ...
	 */
	@Field(9) 
	private CThostFtdcReqFutureSignOutField PlateSerial(int PlateSerial) {
	 ...
	 */
	@Field(10) 
	private CThostFtdcReqFutureSignOutField LastFragment(byte LastFragment) {
	 ...
	 */
	@Field(11) 
	private CThostFtdcReqFutureSignOutField SessionID(int SessionID) {
	 ...
	 */
	@Field(12) 
	private CThostFtdcReqFutureSignOutField InstallID(int InstallID) {
	 ...
	 */
	@Field(19) 
	private CThostFtdcReqFutureSignOutField RequestID(int RequestID) {
	 ...
	 */
	@Field(20) 
	private CThostFtdcReqFutureSignOutField TID(int TID) {
