...
public class CThostFtdcSyncingTradingAccountField extends StructObject {
	 ...
	 */
	@Field(2) 
	private CThostFtdcSyncingTradingAccountField PreMortgage(double PreMortgage) {
	 ...
	 */
	@Field(3) 
	private CThostFtdcSyncingTradingAccountField PreCredit(double PreCredit) {
	 ...
	 */
	@Field(4) 
	private CThostFtdcSyncingTradingAccountField PreDeposit(double PreDeposit) {
	 ...
	 */
	@Field(5) 
	private CThostFtdcSyncingTradingAccountField PreBalance(double PreBalance) {
	 ...
	 */
	@Field(6) 
	private CThostFtdcSyncingTradingAccountField PreMargin(double PreMargin) {
	 ...
	 */
	@Field(7) 
	private CThostFtdcSyncingTradingAccountField InterestBase(double InterestBase) {
	 ...
	 */
	@Field(8) 
	private CThostFtdcSyncingTradingAccountField Interest(double Interest) {
	 ...
	 */
	@Field(9) 
	private CThostFtdcSyncingTradingAccountField Deposit(double Deposit) {
	 ...
	 */
	@Field(10) 
	private CThostFtdcSyncingTradingAccountField Withdraw(double Withdraw) {
	 ...
	 */
	@Field(11) 
	private CThostFtdcSyncingTradingAccountField FrozenMargin(double FrozenMargin) {
	 ...
	 */
	@Field(12) 
	private CThostFtdcSyncingTradingAccountField FrozenCash(double FrozenCash) {
	 ...
	 */
	@Field(13) 
	private CThostFtdcSyncingTradingAccountField FrozenCommission(double FrozenCommission) {
	 ...
	 */
	@Field(14) 
	private CThostFtdcSyncingTradingAccountField CurrMargin(double CurrMargin) {
	 ...
	 */
	@Field(15) 
	private CThostFtdcSyncingTradingAccountField CashIn(double CashIn) {
	 ...
	 */
	@Field(16) 
	private CThostFtdcSyncingTradingAccountField Commission(double Commission) {
	 ...
	 */
	@Field(17) 
	private CThostFtdcSyncingTradingAccountField CloseProfit(double CloseProfit) {
	 ...
	 */
	@Field(18) 
	private CThostFtdcSyncingTradingAccountField PositionProfit(double PositionProfit) {
	 ...
	 */
	@Field(19) 
	private CThostFtdcSyncingTradingAccountField Balance(double Balance) {
	 ...
	 */
	@Field(20) 
	private CThostFtdcSyncingTradingAccountField Available(double Available) {
	 ...
	 */
	@Field(21) 
	private CThostFtdcSyncingTradingAccountField WithdrawQuota(double WithdrawQuota) {
	 ...
	 */
	@Field(22) 
	private CThostFtdcSyncingTradingAccountField Reserve(double Reserve) {
	 ...
	 */
	@Field(24) 
	private CThostFtdcSyncingTradingAccountField SettlementID(int SettlementID) {
	 ...
	 */
	@Field(25) 
	private CThostFtdcSyncingTradingAccountField Credit(double Credit) {
	 ...
	 */
	@Field(26) 
	private CThostFtdcSyncingTradingAccountField Mortgage(double Mortgage) {
	 ...
	 */
	@Field(27) 
	private CThostFtdcSyncingTradingAccountField ExchangeMargin(double ExchangeMargin) {
	 ...
	 */
	@Field(28) 
	private CThostFtdcSyncingTradingAccountField DeliveryMargin(double DeliveryMargin) {
	 ...
	 */
	@Field(29) 
	private CThostFtdcSyncingTradingAccountField ExchangeDeliveryMargin(double ExchangeDeliveryMargin) {
