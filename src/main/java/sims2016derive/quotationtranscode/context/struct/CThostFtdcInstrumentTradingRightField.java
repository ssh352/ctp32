...
public class CThostFtdcInstrumentTradingRightField extends StructObject {
	 ...
	 */
	@Field(1) 
	private CThostFtdcInstrumentTradingRightField InvestorRange(byte InvestorRange) {
	 ...
	 */
	@Field(4) 
	private CThostFtdcInstrumentTradingRightField TradingRight(byte TradingRight) {
