...
public class CThostFtdcRspRepealField extends StructObject {
	 ...
	 */
	@Field(0) 
	private CThostFtdcRspRepealField RepealTimeInterval(int RepealTimeInterval) {
	 ...
	 */
	@Field(1) 
	private CThostFtdcRspRepealField RepealedTimes(int RepealedTimes) {
	 ...
	 */
	@Field(2) 
	private CThostFtdcRspRepealField BankRepealFlag(byte BankRepealFlag) {
	 ...
	 */
	@Field(3) 
	private CThostFtdcRspRepealField BrokerRepealFlag(byte BrokerRepealFlag) {
	 ...
	 */
	@Field(4) 
	private CThostFtdcRspRepealField PlateRepealSerial(int PlateRepealSerial) {
	 ...
	 */
	@Field(6) 
	private CThostFtdcRspRepealField FutureRepealSerial(int FutureRepealSerial) {
	 ...
	 */
	@Field(16) 
	private CThostFtdcRspRepealField PlateSerial(int PlateSerial) {
	 ...
	 */
	@Field(17) 
	private CThostFtdcRspRepealField LastFragment(byte LastFragment) {
	 ...
	 */
	@Field(18) 
	private CThostFtdcRspRepealField SessionID(int SessionID) {
	 ...
	 */
	@Field(20) 
	private CThostFtdcRspRepealField IdCardType(byte IdCardType) {
	 ...
	 */
	@Field(22) 
	private CThostFtdcRspRepealField CustType(byte CustType) {
	 ...
	 */
	@Field(27) 
	private CThostFtdcRspRepealField InstallID(int InstallID) {
	 ...
	 */
	@Field(28) 
	private CThostFtdcRspRepealField FutureSerial(int FutureSerial) {
	 ...
	 */
	@Field(30) 
	private CThostFtdcRspRepealField VerifyCertNoFlag(byte VerifyCertNoFlag) {
	 ...
	 */
	@Field(32) 
	private CThostFtdcRspRepealField TradeAmount(double TradeAmount) {
	 ...
	 */
	@Field(33) 
	private CThostFtdcRspRepealField FutureFetchAmount(double FutureFetchAmount) {
	 ...
	 */
	@Field(34) 
	private CThostFtdcRspRepealField FeePayFlag(byte FeePayFlag) {
	 ...
	 */
	@Field(35) 
	private CThostFtdcRspRepealField CustFee(double CustFee) {
	 ...
	 */
	@Field(36) 
	private CThostFtdcRspRepealField BrokerFee(double BrokerFee) {
	 ...
	 */
	@Field(39) 
	private CThostFtdcRspRepealField BankAccType(byte BankAccType) {
	 ...
	 */
	@Field(41) 
	private CThostFtdcRspRepealField BankSecuAccType(byte BankSecuAccType) {
	 ...
	 */
	@Field(44) 
	private CThostFtdcRspRepealField BankPwdFlag(byte BankPwdFlag) {
	 ...
	 */
	@Field(45) 
	private CThostFtdcRspRepealField SecuPwdFlag(byte SecuPwdFlag) {
	 ...
	 */
	@Field(47) 
	private CThostFtdcRspRepealField RequestID(int RequestID) {
	 ...
	 */
	@Field(48) 
	private CThostFtdcRspRepealField TID(int TID) {
	 ...
	 */
	@Field(49) 
	private CThostFtdcRspRepealField TransferStatus(byte TransferStatus) {
	 ...
	 */
	@Field(50) 
	private CThostFtdcRspRepealField ErrorID(int ErrorID) {
	...
	public void setErrorMsg(String errorMsg) {
		this.io.getPointerField(this, 51).setCString(errorMsg);
	}
