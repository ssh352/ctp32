...
public class CThostFtdcRspQueryAccountField extends StructObject {
	 ...
	 */
	@Field(9) 
	private CThostFtdcRspQueryAccountField PlateSerial(int PlateSerial) {
	 ...
	 */
	@Field(10) 
	private CThostFtdcRspQueryAccountField LastFragment(byte LastFragment) {
	 ...
	 */
	@Field(11) 
	private CThostFtdcRspQueryAccountField SessionID(int SessionID) {
	 ...
	 */
	@Field(13) 
	private CThostFtdcRspQueryAccountField IdCardType(byte IdCardType) {
	 ...
	 */
	@Field(15) 
	private CThostFtdcRspQueryAccountField CustType(byte CustType) {
	 ...
	 */
	@Field(20) 
	private CThostFtdcRspQueryAccountField FutureSerial(int FutureSerial) {
	 ...
	 */
	@Field(21) 
	private CThostFtdcRspQueryAccountField InstallID(int InstallID) {
	 ...
	 */
	@Field(23) 
	private CThostFtdcRspQueryAccountField VerifyCertNoFlag(byte VerifyCertNoFlag) {
	 ...
	 */
	@Field(26) 
	private CThostFtdcRspQueryAccountField BankAccType(byte BankAccType) {
	 ...
	 */
	@Field(28) 
	private CThostFtdcRspQueryAccountField BankSecuAccType(byte BankSecuAccType) {
	 ...
	 */
	@Field(31) 
	private CThostFtdcRspQueryAccountField BankPwdFlag(byte BankPwdFlag) {
	 ...
	 */
	@Field(32) 
	private CThostFtdcRspQueryAccountField SecuPwdFlag(byte SecuPwdFlag) {
	 ...
	 */
	@Field(34) 
	private CThostFtdcRspQueryAccountField RequestID(int RequestID) {
	 ...
	 */
	@Field(35) 
	private CThostFtdcRspQueryAccountField TID(int TID) {
	 ...
	 */
	@Field(36) 
	private CThostFtdcRspQueryAccountField BankUseAmount(double BankUseAmount) {
	 ...
	 */
	@Field(37) 
	private CThostFtdcRspQueryAccountField BankFetchAmount(double BankFetchAmount) {
