...
public class CThostFtdcReqSyncKeyField extends StructObject {
	 ...
	 */
	@Field(9) 
	private CThostFtdcReqSyncKeyField PlateSerial(int PlateSerial) {
	 ...
	 */
	@Field(10) 
	private CThostFtdcReqSyncKeyField LastFragment(byte LastFragment) {
	 ...
	 */
	@Field(11) 
	private CThostFtdcReqSyncKeyField SessionID(int SessionID) {
	 ...
	 */
	@Field(12) 
	private CThostFtdcReqSyncKeyField InstallID(int InstallID) {
	 ...
	 */
	@Field(18) 
	private CThostFtdcReqSyncKeyField RequestID(int RequestID) {
	 ...
	 */
	@Field(19) 
	private CThostFtdcReqSyncKeyField TID(int TID) {
