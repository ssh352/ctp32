...
public class CThostFtdcOrderField extends StructObject {
	 ...
	 */
	@Field(5) 
	private CThostFtdcOrderField OrderPriceType(byte OrderPriceType) {
	 ...
	 */
	@Field(6) 
	private CThostFtdcOrderField Direction(byte Direction) {
	 ...
	 */
	@Field(9) 
	private CThostFtdcOrderField LimitPrice(double LimitPrice) {
	 ...
	 */
	@Field(10) 
	private CThostFtdcOrderField VolumeTotalOriginal(int VolumeTotalOriginal) {
	 ...
	 */
	@Field(11) 
	private CThostFtdcOrderField TimeCondition(byte TimeCondition) {
	 ...
	 */
	@Field(13) 
	private CThostFtdcOrderField VolumeCondition(byte VolumeCondition) {
	 ...
	 */
	@Field(14) 
	private CThostFtdcOrderField MinVolume(int MinVolume) {
	 ...
	 */
	@Field(15) 
	private CThostFtdcOrderField ContingentCondition(byte ContingentCondition) {
	 ...
	 */
	@Field(16) 
	private CThostFtdcOrderField StopPrice(double StopPrice) {
	 ...
	 */
	@Field(17) 
	private CThostFtdcOrderField ForceCloseReason(byte ForceCloseReason) {
	 ...
	 */
	@Field(18) 
	private CThostFtdcOrderField IsAutoSuspend(int IsAutoSuspend) {
	 ...
	 */
	@Field(20) 
	private CThostFtdcOrderField RequestID(int RequestID) {
	 ...
	 */
	@Field(27) 
	private CThostFtdcOrderField InstallID(int InstallID) {
	 ...
	 */
	@Field(28) 
	private CThostFtdcOrderField OrderSubmitStatus(byte OrderSubmitStatus) {
	 ...
	 */
	@Field(29) 
	private CThostFtdcOrderField NotifySequence(int NotifySequence) {
	 ...
	 */
	@Field(31) 
	private CThostFtdcOrderField SettlementID(int SettlementID) {
	 ...
	 */
	@Field(33) 
	private CThostFtdcOrderField OrderSource(byte OrderSource) {
	 ...
	 */
	@Field(34) 
	private CThostFtdcOrderField OrderStatus(byte OrderStatus) {
	 ...
	 */
	@Field(35) 
	private CThostFtdcOrderField OrderType(byte OrderType) {
	 ...
	 */
	@Field(36) 
	private CThostFtdcOrderField VolumeTraded(int VolumeTraded) {
	 ...
	 */
	@Field(37) 
	private CThostFtdcOrderField VolumeTotal(int VolumeTotal) {
	 ...
	 */
	@Field(46) 
	private CThostFtdcOrderField SequenceNo(int SequenceNo) {
	 ...
	 */
	@Field(47) 
	private CThostFtdcOrderField FrontID(int FrontID) {
	 ...
	 */
	@Field(48) 
	private CThostFtdcOrderField SessionID(int SessionID) {
	 ...
	 */
	@Field(51) 
	private CThostFtdcOrderField UserForceClose(int UserForceClose) {
	 ...
	 */
	@Field(53) 
	private CThostFtdcOrderField BrokerOrderSeq(int BrokerOrderSeq) {
	 ...
	 */
	@Field(55) 
	private CThostFtdcOrderField ZCETotalTradedVolume(int ZCETotalTradedVolume) {
	 ...
	 */
	@Field(56) 
	private CThostFtdcOrderField IsSwapOrder(int IsSwapOrder) {
