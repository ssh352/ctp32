...
public class CThostFtdcRspFutureSignInField extends StructObject {
	 ...
	 */
	@Field(9) 
	private CThostFtdcRspFutureSignInField PlateSerial(int PlateSerial) {
	 ...
	 */
	@Field(10) 
	private CThostFtdcRspFutureSignInField LastFragment(byte LastFragment) {
	 ...
	 */
	@Field(11) 
	private CThostFtdcRspFutureSignInField SessionID(int SessionID) {
	 ...
	 */
	@Field(12) 
	private CThostFtdcRspFutureSignInField InstallID(int InstallID) {
	 ...
	 */
	@Field(19) 
	private CThostFtdcRspFutureSignInField RequestID(int RequestID) {
	 ...
	 */
	@Field(20) 
	private CThostFtdcRspFutureSignInField TID(int TID) {
	 ...
	 */
	@Field(21) 
	private CThostFtdcRspFutureSignInField ErrorID(int ErrorID) {
