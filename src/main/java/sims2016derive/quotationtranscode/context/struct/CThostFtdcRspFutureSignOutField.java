...
public class CThostFtdcRspFutureSignOutField extends StructObject {
	 ...
	 */
	@Field(9) 
	private CThostFtdcRspFutureSignOutField PlateSerial(int PlateSerial) {
	 ...
	 */
	@Field(10) 
	private CThostFtdcRspFutureSignOutField LastFragment(byte LastFragment) {
	 ...
	 */
	@Field(11) 
	private CThostFtdcRspFutureSignOutField SessionID(int SessionID) {
	 ...
	 */
	@Field(12) 
	private CThostFtdcRspFutureSignOutField InstallID(int InstallID) {
	 ...
	 */
	@Field(19) 
	private CThostFtdcRspFutureSignOutField RequestID(int RequestID) {
	 ...
	 */
	@Field(20) 
	private CThostFtdcRspFutureSignOutField TID(int TID) {
	 ...
	 */
	@Field(21) 
	private CThostFtdcRspFutureSignOutField ErrorID(int ErrorID) {
