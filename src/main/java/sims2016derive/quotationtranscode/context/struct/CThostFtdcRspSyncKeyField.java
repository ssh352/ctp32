...
public class CThostFtdcRspSyncKeyField extends StructObject {
	 ...
	 */
	@Field(9) 
	private CThostFtdcRspSyncKeyField PlateSerial(int PlateSerial) {
	 ...
	 */
	@Field(10) 
	private CThostFtdcRspSyncKeyField LastFragment(byte LastFragment) {
	 ...
	 */
	@Field(11) 
	private CThostFtdcRspSyncKeyField SessionID(int SessionID) {
	 ...
	 */
	@Field(12) 
	private CThostFtdcRspSyncKeyField InstallID(int InstallID) {
	 ...
	 */
	@Field(18) 
	private CThostFtdcRspSyncKeyField RequestID(int RequestID) {
	 ...
	 */
	@Field(19) 
	private CThostFtdcRspSyncKeyField TID(int TID) {
	 ...
	 */
	@Field(20) 
	private CThostFtdcRspSyncKeyField ErrorID(int ErrorID) {
