...
public class CThostFtdcQueryMaxOrderVolumeWithPriceField extends StructObject {
	 ...
	 */
	@Field(3) 
	private CThostFtdcQueryMaxOrderVolumeWithPriceField Direction(byte Direction) {
	 ...
	 */
	@Field(4) 
	private CThostFtdcQueryMaxOrderVolumeWithPriceField OffsetFlag(byte OffsetFlag) {
	 ...
	 */
	@Field(5) 
	private CThostFtdcQueryMaxOrderVolumeWithPriceField HedgeFlag(byte HedgeFlag) {
	 ...
	 */
	@Field(6) 
	private CThostFtdcQueryMaxOrderVolumeWithPriceField MaxVolume(int MaxVolume) {
	 ...
	 */
	@Field(7) 
	private CThostFtdcQueryMaxOrderVolumeWithPriceField Price(double Price) {
