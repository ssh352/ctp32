...
public class CThostFtdcTransferBankToFutureReqField extends StructObject {
	 ...
	 */
	@Field(1) 
	private CThostFtdcTransferBankToFutureReqField FuturePwdFlag(byte FuturePwdFlag) {
	 ...
	 */
	@Field(3) 
	private CThostFtdcTransferBankToFutureReqField TradeAmt(double TradeAmt) {
	 ...
	 */
	@Field(4) 
	private CThostFtdcTransferBankToFutureReqField CustFee(double CustFee) {
